...
namespace Motofushin.Infrastructure.Services;

/// <summary>
/// GPX track store reading track files (*.gpx) from a configured assets directory.
/// </summary>
public sealed class FileSystemGpxTrackStore(string assetsPath = "C:\\Users\\Viktor\\source\\Pet\\motofushin\\motofushin-backend\\src\\Motofushin.Api\\Assets") : IGpxTrackStore
{
